...
utils.smoothscrolling = 
    loadstring(game:HttpGet("https://raw.githubusercontent.com/lug1adev/hnp hub/main/SmoothScroll.lua", true))()
...
library.createWindow = 
    function(skipLoader)
	    -- title = title or "hnp hub"

        if not shared._hnp then
            return library.notify("Please close the current UI or restart the game!")
        end
...
do 
    ...
    local CreditTab = Window.createTab("hnp hub V2 [Free]", true)

    CreditTab.createTabHeader("hnp hub")
    ...
    local DD = CreditTab.createDropdown("hnp hub Nigga", icon, false, s, 1, function(a)
        print(a)
    end)
    ...
    local LB = CreditTab.createLabel("hnp hub Lug1a", icon)

    CreditTab.createButton("hnp hub Negar", icon, function()
    ...
    local ADLB = ADT.createLabel("hnp hub UWU", icon)

    ADT.createSlider("UWUZURE", icon, 0, 100, 50, function(a)
        print(a)
    end)

    ADT.createToggle("hnp hub hnp hub hnp hub hnp hub", icon, false, function(a)
        print(a)
        ADLB.Update(a)
    end)
